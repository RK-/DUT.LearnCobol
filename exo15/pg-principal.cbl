       ...
       screen section.
       1 a-plg-titre line 1 col 20 'Exercice 15'.
       1 s-plg-chaine.
       ...
       procedure division.
           ...
           accept s-chaine
           compute n = function nb-chiffres(chaine)
           display a-plg-n
           call 'SPP_somme_produit' using chaine somme produit end-call
           display a-plg-somme
